...
public class UsuarioDaoImp implements UsuarioDao{
	...
	public List<Map<String, Object>> validarUser(Usuario u) {
		// TODO Auto-generated method stub
		String sql = "select u.IDUSUARIO, u.NOM_USER, r.IDROL, r.NOM_ROL, p.MENU, p.URL from USUARIO u, ROL r, PRIVILEGIO p "+
                "where u.IDROL=r.IDROL and r.IDROL = p.IDROL and u.NOM_USER='"+u.getNomuser()+"' and u.CLAVE="+u.getClave();
